        ...
        <div>
            {!quizStarted ? ( 
                <div className="max-w-md mx-auto bg-gray-100 p-6 rounded-lg shadow-lg">
                    <h2 className="text-xl font-semibold text-center mb-4">Quiz Setting</h2>
                    <form onSubmit={handleSelection}>
                        ...
                        <button type="submit" className="w-full bg-gray-700 text-white p-3 rounded-lg hover:bg-gray-600 transition-all">
                            Start Quiz
                        </button>
                    </form>
                </div>
