...
export default function Results() {
    ...
    const handleRestartQuiz = () => {
        ...
        router.push('/quiz'); // Omdirigera till quiz-sidan
    };

    return (
        <div className="max-w-3xl mx-auto m-10 p-20 bg-gray-100 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-center mb-4 pb-4">Quiz Results</h2>
            ...
            <div className="mt-10 text-center">
                <button
                    ...
                    onClick={handleRestartQuiz} // Använd handleRestartQuiz
                >
                    Restart Quiz
                </button>
            </div>
